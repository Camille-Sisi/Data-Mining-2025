...
![](images/Structure%20generale%20Ggplot2.png)
...
Pour la liste des symboles ("shape") et le numéro correspondant que l'on appelera avec l'argument `shape=`, ci-dessous un récapitulatif : ![](images/Liste%20symboles%20Ggplot2.png)

Et voici pour la liste des types de lignes, avec `linetype=` : ![](images/Type%20de%20lignes%20Ggplot2.png)
...
Il y a plusieurs thèmes existants dans le package **`ggplot2`**, `theme_gray()` est le thème par défaut ; les autres sont présentés dans la figure ci-dessous. ![](Images/Liste%20Themes%20Ggplot.png)
